...
public class LovinValid {

	
	
	@Test
	public void login_valid() throws EncryptedDocumentException, IOException {
		...
		String value1 = WorkbookFactory.create(file).getSheet("valid_data").getRow(0).getCell(0).getStringCellValue();
